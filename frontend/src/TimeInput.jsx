...
export default function TimeInput({ seconds, onChange, maxSeconds = 5999, disabled = false }) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      <input
        type="number" min="0" inputMode="numeric" disabled={disabled} aria-label="Minutos"
        value={mins}
      ...
      <input
        type="number" min="0" max="59" inputMode="numeric" disabled={disabled} aria-label="Segundos"
        value={secs}
